...
/*
	...
	OF USE,     , OR PROFITS; OR BUSINESS INTERRUPTION) ARISING IN ANY WAY OUT OF THE USE,
...
@protocol ReceivedMessageDelegate <NSObject>
@optional
...
@interface RFCommComunication: NSObject
// Bluetooth variables:
@property (strong,nonatomic)NSString *message;


@property (strong, nonatomic)IOBluetoothDevice *mBluetoothDevice;
...
//- (NSString*)rfcommChannelData:(IOBluetoothRFCOMMChannel *)rfcommChannel data:(void *)dataPointer length:(size_t)dataLength;
